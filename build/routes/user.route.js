...
router.post('', _user2.newUserValidator, userController.newUser); //route to register a new user

router.post('/register', _user2.newUserValidator, userController.registerUser); //route to login a registered user

router.post('/login', userController.loginUser); //route to get a single user by their user id
